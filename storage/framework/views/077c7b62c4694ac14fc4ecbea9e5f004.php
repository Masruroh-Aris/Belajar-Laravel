    ...
    <main style="max-width: 900px; margin: 50px auto; padding: 30px; 
        ...
        <div style="display: flex; gap: 30px; align-items: flex-start; flex-wrap: wrap;">
            <div style="flex: 1; text-align: center;">
                <img src="<?php echo e(asset('image/Ida-Mas.jpg')); ?>" 
...
<?php /**PATH D:\SEMESTER 5\Pemrograman Framework\2023150103-IDAMAS\laravel\resources\views/datadiri.blade.php ENDPATH**/ ?>